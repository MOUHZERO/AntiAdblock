!function () {
  function f() {
    ...
    a.innerHTML = '<div class="inner"> \
      ...
      <div class="isi"> \
        <h3>مرحبًا! أردت فقط أن أخبرك بأننا لا نستخدم أي إعلانات مزعجة على موقعنا، هل تمانع في إيقاف تشغيل أداة حظر الإعلانات للمساهمة في دعم موقعنا؟<br> شكرًا جزيلاً!</h3> \
